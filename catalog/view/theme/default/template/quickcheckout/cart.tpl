    ...
    <table class="table cart">
      ...
      <tbody>
        ...
        <tr <?php echo(!$product['stock']) ? 'class="stock"' : '' ;?>>
          <td class="image <?php echo (!$data['columns']['image'])?  'hide' : '' ?> "><a  rel="popup" data-help='<img src="<?php echo $product['image']; ?>" />'  href="<?php echo $product['href']; ?>"><img src="<?php echo $product['thumb']; ?>" /></a><i rel="tooltip" data-help="'.$field['tooltip'] .'"></i></td>
          <td class="name  <?php echo (!$data['columns']['name'])?  'hide' : '' ?> ">
		  <a href="<?php echo $product['href']; ?>" <?php echo (!$data['columns']['image'])?  'rel="popup" data-help=\'<img src="'.$product['image'].'"/>\'' : '' ?>> <!--<img src="<?php echo $product['thumb']; ?>" class="hide <?php echo (!$data['columns']['image'])?  '' : 'show' ?>" />--> <?php echo $product['name']; ?> <?php echo (!$product['stock'])? '<span class="out-of-stock">***</span>' : '' ?>
		  </a>
