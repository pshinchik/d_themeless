...
<div id="content_holder"><!-- content_holder -->
	<div class="layout"><!-- layout -->
		...
		<article id="content" class="category-page">
				...
				<div class="product-list">
					...
					<div class="row block-list-product">
						...
						<div class="col-sm-6 col-xs-8">
							...
							<?php } ?>
							<div class="btn-group">
								<a onclick="addToWishList('<?php echo $product['product_id']; ?>');" class="btn btn-link" title="<?php echo $button_wishlist; ?>">
									<span class="icon icon-icon-heart"></span>
									<?php echo $button_wishlist; ?>
								</a>
								<a onclick="addToCompare('<?php echo $product['product_id']; ?>');" class="btn btn-link" title="<?php echo $button_compare; ?>">								
						...
						<div class="col-sm-2 col-xs-4 price-block">
							<?php if ($product['price']) { ?>
							<div class="price">
								<?php if (!$product['special']) { ?>
								<span class="price-new label label-info"><span class="icon icon-white icon-tag"></span> <?php echo $product['price']; ?></span>
								<?php } else { ?>
								<span class="price-new label label-warning" style="font-size: inherit;">
									<span class="icon icon-white icon-tag"></span><?php echo $product['special']; ?>
								</span>
...
function display(view) {
	if (view == 'list') {
		...
		$('.product-list').each(function(index, element) {
			...
			html += '<div class="cart-quantity-list">';
