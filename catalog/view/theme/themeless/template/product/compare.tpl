	...
	<div class="layout"><!-- layout -->
		...
		<?php echo $column_left; ?><?php echo $column_right; ?>
			<div id="content"><?php echo $content_top; ?><!-- content -->
			  ...
			  <?php if ($products) { ?>
			  <table class="compare-info table table-condensed table-bordered">
				<thead>
				  <tr>
				...
				<tbody>
				  ...
				  <tr>
					...
					<?php foreach ($products as $product) { ?>
					<td><img src="catalog/view/theme/themeless/image/stars-<?php echo $products[$product['product_id']]['rating']; ?>.png" alt="<?php echo $products[$product['product_id']]['reviews']; ?>" /><br />
