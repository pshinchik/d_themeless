<div class="row">
<div class="left col-sm-6 form-horizontal">
	<fieldset>
...
<div class="right col-sm-6 form-horizontal">
	<fieldset>
  ...
  <div style="display: <?php echo (count($customer_groups) > 1 ? 'table-row' : 'none'); ?>;" class="control-group">
  	<label class="control-label">
  	...
  	<div class="controls">
  		<?php foreach ($customer_groups as $customer_group) { ?>
			...
			<label for="customer_group_id<?php echo $customer_group['customer_group_id']; ?>" class="radio styled" >
...
<div style="clear: both; padding-top: 15px; border-top: 1px solid #EEEEEE;">
  <label for="newsletter" class="checkbox"><input type="checkbox" name="newsletter" value="1" id="newsletter" class="styled" />
  <?php echo $entry_newsletter; ?></label>
  <br />
  <?php if ($shipping_required) { ?>
  <label for="shipping" class="checkbox"><input type="checkbox" name="shipping_address" value="1" id="shipping" checked="checked" class="styled" />
...
<div class="buttons row">
    ...
    <input type="checkbox" name="agree" value="1" class="styled" /></label>
	</div>
	<div class="col-sm-6">
    <input type="button" value="<?php echo $button_continue; ?>" id="button-register" class="button btn btn-primary" />
  </div>
</div>
<?php } else { ?>
<div class="buttons row">
