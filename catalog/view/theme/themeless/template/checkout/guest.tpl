...
<div class="right col-sm-6 form-horizontal">
  ...
  <div class="control-group" style="display: <?php echo (count($customer_groups) > 1 ? 'table-row' : 'none'); ?>;">
    ...
    <label for="customer_group_id<?php echo $customer_group['customer_group_id']; ?>" class="radio">
    <input type="radio" name="customer_group_id" value="<?php echo $customer_group['customer_group_id']; ?>" id="customer_group_id<?php echo $customer_group['customer_group_id']; ?>" checked="checked" class="styled" />
    <?php echo $customer_group['name']; ?></label>
    <?php } else { ?>
    <label for="customer_group_id<?php echo $customer_group['customer_group_id']; ?>" class="radio">
    <input type="radio" name="customer_group_id" value="<?php echo $customer_group['customer_group_id']; ?>" id="customer_group_id<?php echo $customer_group['customer_group_id']; ?>" class="styled" />
    <?php echo $customer_group['name']; ?></label>
    <?php } ?>
    <?php } ?>
    </div>
...
<div class="buttons">
  <div class="right">
    <input type="button" value="<?php echo $button_continue; ?>" id="button-guest" class="button btn btn-primary" />
  </div>
</div>
