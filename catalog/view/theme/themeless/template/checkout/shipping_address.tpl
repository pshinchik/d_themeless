<?php if ($addresses) { ?>
<label for="shipping-address-existing" class="radio"><input type="radio" name="shipping_address" value="existing" id="shipping-address-existing" checked="checked" class="styled" />
...
<p>
	<label for="shipping-address-new" class="radio">
...
<div id="shipping-new" style="display: <?php echo ($addresses ? 'none' : 'block'); ?>;">
  ...
  <div class="form-horizontal">
    ...
    <div class="control-group">
      ...
      <div class="controls"><input type="text" name="postcode" value="<?php echo $postcode; ?>" class="large-field" /></div>
    </div>
    <div class="control-group">
...
<div class="buttons">
  <div class="right">
    <input type="button" value="<?php echo $button_continue; ?>" id="button-shipping-address" class="button btn btn-primary" />
  </div>
</div>
