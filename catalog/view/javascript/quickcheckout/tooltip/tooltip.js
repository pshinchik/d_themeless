...
var dpopup = {
    ...
    init : function() {
        ...
        jQuery(document).on('mouseover', '[rel="popup"]', function() {

            dpopup.open(this);
        });

        jQuery(document).on('mouseout', '[rel="popup"]', function() {
            dpopup.close();
        });
    },
    ...
    open : function(el) {
        ...
        // Create popup
        jQuery('body').prepend( jQuery('<div>', { 'class' : 'qc popup'})
            .append( jQuery('<div>', { 'class' : 'inner' }))
            .append( jQuery('<span>') )
        );
